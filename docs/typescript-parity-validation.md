...
- Slack replies, active thread routing, flag-reaction translation, Slack image input, generated-media upload/handoff, and AgentRunner success logging: `tests/slack/agentHandlers.test.ts`
...
- An app mention or active thread follow-up with an image attachment reaches an image-capable model as image input.
