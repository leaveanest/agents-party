...
- PostgreSQL migrations and repository behavior for Slack installations, routing, OAuth, work items, audit events, attention indexes, and calendar links: `tests/infrastructure/postgres/*.test.ts`
...
- Work item capture/list/update commands persist items, participants, events, attention indexes, and Slack-visible results.
